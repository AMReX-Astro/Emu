                        ...
                        // (0 for IMFP_method 0/1, NuLib group for method 2).
                        {
                            ...
                            C_in_scat_pp_01_Re +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               PIdx::offset(0, 1, PIdx::Re)));
                            C_in_scat_pp_01_Im +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               PIdx::offset(0, 1, PIdx::Im)));
                            C_in_scat_pp_11_Re +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                            ...
                            C_in_scat_pp_00_Rebar +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               nubar + PIdx::offset(0, 0)));
                            C_in_scat_pp_01_Rebar +=
                                vol *
                                sarr(i, j, k,
                                     GIdx::C_in_scat_iso_index(
                                         energy_bin,
                                         nubar + PIdx::offset(0, 1, PIdx::Re)));
                            C_in_scat_pp_01_Imbar +=
                                vol *
                                sarr(i, j, k,
                                     GIdx::C_in_scat_iso_index(
                                         energy_bin,
                                         nubar + PIdx::offset(0, 1, PIdx::Im)));
                            C_in_scat_pp_11_Rebar +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               nubar + PIdx::offset(1, 1)));
#elif NUM_FLAVORS == 3
                            C_in_scat_pp_00_Re +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                            ...
                            C_in_scat_pp_02_Re +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               PIdx::offset(0, 2, PIdx::Re)));
                            C_in_scat_pp_02_Im +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               PIdx::offset(0, 2, PIdx::Im)));
                            C_in_scat_pp_12_Re +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               PIdx::offset(1, 2, PIdx::Re)));
                            C_in_scat_pp_12_Im +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               PIdx::offset(1, 2, PIdx::Im)));
                            C_in_scat_pp_22_Re +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                            ...
                            C_in_scat_pp_02_Rebar +=
                                ...
                                sarr(i, j, k,
                                     GIdx::C_in_scat_iso_index(
                                         energy_bin,
                                         nubar + PIdx::offset(0, 2, PIdx::Re)));
                            C_in_scat_pp_02_Imbar +=
                                vol *
                                sarr(i, j, k,
                                     GIdx::C_in_scat_iso_index(
                                         energy_bin,
                                         nubar + PIdx::offset(0, 2, PIdx::Im)));
                            C_in_scat_pp_12_Rebar +=
                                vol *
                                sarr(i, j, k,
                                     GIdx::C_in_scat_iso_index(
                                         energy_bin,
                                         nubar + PIdx::offset(1, 2, PIdx::Re)));
                            C_in_scat_pp_12_Imbar +=
                                vol *
                                sarr(i, j, k,
                                     GIdx::C_in_scat_iso_index(
                                         energy_bin,
                                         nubar + PIdx::offset(1, 2, PIdx::Im)));
                            C_in_scat_pp_22_Rebar +=
                                vol * sarr(i, j, k,
                                           GIdx::C_in_scat_iso_index(
                                               energy_bin,
                                               nubar + PIdx::offset(2, 2)));
#endif
                        }
                    }
                }
