...
This script is used to generate an HDF5 file that contains constant background matter information in spherical coordinates: rho (density), Yₑ (electron fraction), and T (temperature). 
